...
# the bundled package to their respective `../database/source/nodejsshim/lib/`
...
build_assert () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/assert/dist/assert.sql"
...
build_buffer () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/buffer/dist/buffer.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="4.6.0"
...
build_buffer_browserify () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/buffer-browserify/dist/buffer-browserify.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="0.2.5"
...
build_events () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/events/dist/events.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="1.1.0"
...
build_http_parser () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/http-parser/dist/http-parser.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="0.4.2"
...
build_path () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/path/dist/path.sql"
  local SCHEMANAME="nodejsshim"
...
build_process () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/process/dist/process.sql"
  local SCHEMANAME="nodejsshim"
...
build_punycode () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/punycode/dist/punycode.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="1.4.1"
...
build_querystring () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/querystring/dist/querystring.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="0.2.1"
...
build_stream () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/stream/dist/stream.sql"
  local SCHEMANAME="nodejsshim"
  local VERSION="2.0.1"
...
build_string_decoder () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/string_decoder/dist/string_decoder.sql"
  local SCHEMANAME="nodejsshim"
...
build_url () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/url/dist/url.sql"
  local SCHEMANAME="nodejsshim"
...
build_util () {
  ...
  local OUTPUTPATH="$DIR/../database/source/nodejsshim/lib/util/dist/util.sql"
  local SCHEMANAME="nodejsshim"
