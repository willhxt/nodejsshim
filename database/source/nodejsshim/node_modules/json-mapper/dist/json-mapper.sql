...
SELECT nodejsshim.npm_install('nodejsshim'::text, 'json-mapper'::text, '0.0.10'::text, 'https://github.com/dregenor/jsonMapper'::text, $code_body$ 
...
},{}],"json-mapper":[function(require,module,exports){
