...
SELECT nodejsshim.npm_install('nodejsshim'::text, 'buffer-browserify'::text, '0.2.5'::text, 'https://github.com/toots/buffer-browserify'::text, $code_body$ 
...
},{"./buffer_ieee754":1,"assert":undefined,"base64-js":2}]},{},[]); 
$code_body$::text); 
